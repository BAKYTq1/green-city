...
import Logo from "../../assets/IMG_0371.png";

const aboutSlides = [
  {
    id: "a1",
    bg: "https://i.pinimg.com/736x/c5/69/6f/c5696f825f78dd4be31349d1ef6d209b.jpg",
  },
  {
    id: "a2",
    bg: "https://i.pinimg.com/1200x/6d/1f/e4/6d1fe4be349834baffa4064c89c5f24d.jpg",
  },
  {
    id: "a3",
    bg: "https://i.pinimg.com/736x/35/0b/24/350b2426dcce60ca73887ae2a48df34b.jpg",
  },
  {
    id: "a4",
    bg: "https://i.pinimg.com/1200x/f8/69/51/f86951719b406d8c9495664156497693.jpg",
  },
  {
    id: "a5",
    bg: "https://i.pinimg.com/1200x/7a/50/a1/7a50a1c4ad6a073f71fe1f42c61fb354.jpg",
  },
];
...
export default function HeaderHome() {
  ...
  return (
    <>
      <nav
        className={`gc-nav gc-nav--fixed ${scrolled ? "scrolled" : ""} ${isDark ? "dark" : ""}`}
        ref={navRef}
      >
        <div className="gc-nav-left">
          <button
            className="gc-theme-btn"
            onClick={toggleTheme}
            aria-label="Тема"
          >
            {isDark ? (
          ...
          <Link to="/objects" className="gc-objects-link">
            {t.headerHome.objects}
          </Link>
        </div>

        <TransitionLink to="/" className="gc-logo" ref={logoRef}>
          <div className="gc-logo-icon">
            <img src={Logo} alt="Green City Logo" />
          </div>
        </TransitionLink>

        <div className="gc-nav-right">
          <a href="tel:+996556111444" className="gc-phone">
            {t.headerHome.phone}
          </a>
          ...
          <button
            className={`gc-burger ${menuOpen ? "open" : ""}`}
        ...
        <header className={`gc-header ${isDark ? "dark" : ""}`}>
          ...
          >
            {currentSlides.map((slide) => (
              <SwiperSlide
                ...
                data-swiper-autoplay={
                  isAbout ? Math.round(5000 + Math.random() * 5000) : undefined
                }
              >
                <div
                  className="gc-slide"
            ...
            <div className="gc-controls">
              ...
              <div
                className={`gc-nav-btns ${isAbout ? "gc-nav-btns--ghost" : ""}`}
              >
                <button className="gc-prev">
                  <HiArrowSmallLeft />
                </button>
                <button className="gc-next">
                  <HiArrowSmallRight />
                </button>
              </div>
            </div>
