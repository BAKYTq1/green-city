...
export default function Header() {
  ...
  const slides = [
    { id: 1, title: t.slide1_title, subtitle: t.slide1_sub, bg: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1600&q=80' },
    { id: 2, title: t.slide2_title, subtitle: t.slide2_sub, bg: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1600&q=80' },
  ]
    ...
    <header className={`gc-header ${dark ? 'dark' : ''}`}>
      <nav className="gc-nav" ref={navRef}>
          ...
          <Link to="/objects" className="gc-objects-link">{t.objects}</Link>
            ...
            <Link to="/" className="gc-logo m-auto" ref={logoRef}>
