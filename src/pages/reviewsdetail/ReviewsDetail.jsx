...
import styles from './ReviewsDetail.module.scss'
...
export default function ReviewDetail() {
  ...
  const { selectedItem, loading, error, fetchById } = useReviewsStore()
  ...
  const img = selectedItem.image || getYoutubeThumbnail(selectedItem.url)
    ...
    <div className={styles.page}>
      ...
      {img && (
        <div className={styles.imgWrap}>
          <img src={img} alt={selectedItem.name} />
        </div>
      )}
      ...
      <div className={styles.container}>
        <div className={styles.body}>
          ...
          <p className={styles.text}>{selectedItem.descriptions}</p>
